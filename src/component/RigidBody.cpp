...
void RigidBody::script_registration() {
  ...
  L_COMPONENT_METHOD(RigidBody, "angular-drag", 1, angularDrag(c.param(0).get<float>()));
  ...
  L_COMPONENT_RETURN_METHOD(RigidBody, "get-velocity-at", 1, velocityAt(c.param(0).get<Vector3f>()));
  L_COMPONENT_METHOD(RigidBody, "add-speed", 1, addSpeed(c.param(0).get<Vector3f>()));
  L_COMPONENT_METHOD(RigidBody, "add-force", 1, addForce(c.param(0).get<Vector3f>()));
  L_COMPONENT_METHOD(RigidBody, "add-relative-force", 1, addRelativeForce(c.param(0).get<Vector3f>()));
  L_COMPONENT_METHOD(RigidBody, "add-torque", 1, addTorque(c.param(0).get<Vector3f>()));
  L_COMPONENT_METHOD(RigidBody, "add-relative-torque", 1, addRelativeTorque(c.param(0).get<Vector3f>()));
  L_COMPONENT_METHOD(RigidBody, "apply-impulse", 2, applyImpulse(c.param(0).get<Vector3f>(), c.param(0).get<Vector3f>()));
