...
#ifdef L_CPP_INIT_FUNCTION
  {
    L_SCOPE_MARKER("Initializing project");
    extern void L_CPP_INIT_FUNCTION();
    L_CPP_INIT_FUNCTION();
  }
#endif

#ifdef L_SCRIPT_INIT_FILE
  Engine::set_init_script(L_SCRIPT_INIT_FILE);
#endif

  if(Arguments::has("run_all_tests")) {
